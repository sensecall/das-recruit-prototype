module.exports = function(router) {
  ...
  const base_url = 'raa-v2/' + version + "/autocheck"
  ...
  router.post('/' + base_url + '*/create/short-description-v2', function(req, res) {
    res.redirect(301, '/' + base_url + req.params[0] + '/create/vacancy-preview-v2?edit=no&has_advisory=yes')
  })
  router.post('/' + base_url + '*/create/vacancy-preview-v2', function(req, res) {
    res.redirect(301, '/' + base_url + req.params[0] + '/create/advisory')
  })
